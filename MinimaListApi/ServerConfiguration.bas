...
Sub Class_Globals
	...
	Private ALLOW_STATIC_FILES As Boolean = True
...
Private Sub ConfigurePaths
	ROOT_URL = Main.Config.Get("ROOT_URL")
	...
	' Root Path
	ROOT_PATH = Main.Config.Get("ROOT_PATH")
	...
	' API Name
	API_NAME = Main.Config.Get("API_NAME")
...
Public Sub ConfigureElements
	...
	' API Versioning
	Dim API_VERSIONING As String = Main.Config.GetDefault("API_VERSIONING", "")
...
Private Sub ConfigureStaticFiles
	Main.Server.StaticFilesFolder = STATIC_FILES_FOLDER ' File.Combine(File.DirApp, "www")
